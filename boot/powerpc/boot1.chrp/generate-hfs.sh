...
# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1 2008/10/14 03:32:41 nwhitehorn Exp $
...
echo '# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1 2008/10/14 03:32:41 nwhitehorn Exp $' >> Makefile.hfs
...
echo '$FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1 2008/10/14 03:32:41 nwhitehorn Exp $' >> $OUTPUT_FILE.bz2.uu
